...
$(document).ready(()=>{
    ...
    // ********************* form validation ***********
      ...
      $("#formStitchingRecordUpdate").validate({
...
var createFormData = $('#formStitchingRecordUpdate').serialize();
var id = $('#stitchingId').val();
    console.log(id);
    $.ajax({
        url: '/dhaaga-clothings/women-stitching-registration/'+id,
        type: 'PATCH',
        data: createFormData,
        // contentType: false,
        processData: false,
