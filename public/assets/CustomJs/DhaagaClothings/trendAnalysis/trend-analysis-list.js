$(document).ready(()=>{
    ...
    var table = $('#tblTrend').DataTable({
          ...
          ajax: {
             "url": "/dhaaga-clothings/trend-analysis/datatable",
             "dataSrc": ""
         },
         columns: [
           { data : 'id'},
          ...
          // },
           ...
           { render : function(data, type, row , full) {
            // console.log(row)
              return `
              <div class="glyph">
                  <a href="/dhaaga-clothings/trend-analysis/`+row.id+`/edit"> <i class="typcn typcn-edit"></i> </a>
    ...
    $('#deleteData').on('submit' , function(event){
      ...
      console.log($trendId)
         ...
         $.ajax({
          url: '/dhaaga-clothings/trend-analysis/'+$trendId,
          type: 'DELETE',
          data: data,
          processData: false,
