...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('/skincare/inventory/batch/create') }}"><i class="fe fe-download"></i> Add New Batch</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
										...
										<table class="table" id="tblBatch">
											<thead>
												<tr>
													...
													<th class="wd-25p">Batch Code </th>
													<th class="wd-20p">Product Name</th>
													<th class="wd-20p">Batch Size</th>
													<th class="wd-20p">Total Quantity</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/MadySkincare/Inventory/Batch/batchs-list.js')}}"></script>
