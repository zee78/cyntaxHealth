						...
						<div class="">
							<div class="row">
								...
								<div class="col-lg-6 col-md-6">
									...
									<input class="form-control" type="hidden" id="glasswareId" value="{{ $getSingleData->id }}">
									<input class="form-control" name="glassware_name" placeholder="Enter Glassware Name" required=""  value="{{ $getSingleData->glassware_name }}" type="text">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="stock_in_hand" placeholder="Enter Stock in Hand" required="" value="{{ $getSingleData->stock_in_hand }}" type="text">
								</div>
							    </div>
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<input type="text" name="breakge" value="{{ $getSingleData->breakge }}" class="form-control" required="">
								</div>
							    </div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="responsible_person" id="responsible_person" placeholder="Enter Name of Responsible Person" required="" value="{{ $getSingleData->responsible_person }}" type="text">
								</div>
							    </div>
							</div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/MadySkincare/Inventory/Glassware/glassware-update.js')}}"></script>
@endsection