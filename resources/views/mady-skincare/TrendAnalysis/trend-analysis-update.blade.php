				...
				<div class="mt-3 mb-3">
					<form  id="trendUpdate">
						...
						<div class="">
							<div class="row">
								...
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										...
										<input type="text" name="packs_sold" value="{{ $getSingleData->packs_sold }}" class="form-control" placeholder="Packs sold">
									</div>
								</div>
								<!-- ****************** employee last name *************** -->
							</div>
							<div class="row">
								...
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
										...
										<input class="form-control" name="amount_received" placeholder="Amount Received" required="" type="text" value="{{ $getSingleData->amount_received }}">
									</div>
								</div>
								<div class="col-lg-6 col-md-6">
									<div class="form-group">
							...
							<button class="btn ripple btn-primary pd-x-20" type="submit">Update Trend Analysis</button>
						</div>
					</form>
				</div>
			</div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/MadySkincare/TrendAnalysis/trend-analysis-update.js')}}"></script>
@endsection