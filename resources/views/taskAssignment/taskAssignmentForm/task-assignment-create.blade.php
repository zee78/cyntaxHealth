						...
						<div class="">
                            <div class="row">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control" name="name_of_task" placeholder="Name of Task" required="" type="text">
								...
								<div class="form-group">
									...
									<input class="form-control fc-datepicker" name="date_of_task_assignment" placeholder="MM/DD/YYYY" required="" type="text">
                                </div>
                                </div>
                            ...
                            <div class="row">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control" name="nature_of_task" placeholder="nature_of_task" required="" type="text">
                            ...
                            <div class="row">
								...
								<div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description_of_task" rows="5" required>
                                    </textarea>
                            ...
                            <div class="row">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control fc-datepicker" name="deadline_for_task_submission" placeholder="MM/DD/YYYY" required="" type="text">
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/taskAssignment/taskAssignmentForm/task-assignment-create.js')}}"></script>
