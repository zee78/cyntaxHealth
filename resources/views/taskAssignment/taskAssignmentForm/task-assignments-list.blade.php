...
@section('page-header')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Task Assignemnt</h2>
							<ol class="breadcrumb">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('/task-assignment/task-assignment/create') }}"><i class="fe fe-download"></i> Add New Record</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table" id="tblTaskAssignment">
											<thead>
												<tr>
													<th class="wd-20p">Sr#</th>
													<th class="wd-25p">Name of task</th>
													<th class="wd-25p">Date of task assignment</th>
													<th class="wd-25p">Deadline for task submission </th>
													<th class="wd-25p">Nature of task</th>
													<th class="wd-25p">Description of task </th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/taskAssignment/taskAssignmentForm/task-assignments-list.js')}}"></script>
