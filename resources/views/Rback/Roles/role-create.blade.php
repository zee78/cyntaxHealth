										...
										<div class="">
											<div class="row mb-3">
												<div class="col-lg-6 form-group">
													...
													<input class="form-control" name="role" placeholder="Enter role" required="" type="text">
												</div>
											
											</div>
											<button class="btn ripple btn-primary pd-x-20" type="submit">Create Role</button>
										</div>
									</form>
...
<script src="{{ URL::asset('assets/CustomJs/Rback/Roles/role-create.js')}}"></script>
