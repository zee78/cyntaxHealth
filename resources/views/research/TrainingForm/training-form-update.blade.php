						...
						<div class="">
							<div class="row ">
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										<input class="form-control" type="hidden" id="trainingId" value="{{ $getSingleData->id }}">
										<label class="form-label">Title: <span class="tx-danger">*</span></label>
										<input class="form-control" name="title" placeholder="Enter Title" required="" type="text" value="{{ $getSingleData->title }}">
								</div>
								...
								<div class="col-lg-6 col-md-6">
									...
									<select class="form-control" name="type">
										<option value="{{ $getSingleData->type }}"> {{ $getSingleData->type }}</option>
							...
							<div class="row">
								...
								<div class="col-md-6 col-lg-6">
									...
									<input type="text" name="date" class="form-control fc-datepicker" placeholder="MM/DD/YYYY" required="" value="{{ $getSingleData->date }}">
								</div>
								...
								<div class="form-group">
									...
									<input class="form-control" name="speaker" placeholder="Enter Speaker" required="" type="text" value="{{ $getSingleData->speaker }}">
								</div>
								</div>
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<input class="form-control" name="number_participants" id="number_participants" required="" type="number" value="{{ $getSingleData->number_participants }}">
								</div>
							    </div>
								...
								<div class=" form-group">
									...
									<input class="form-control" name="total_amount_received" id="total_amount_received" required="" value="{{ $getSingleData->total_amount_received }}" type="number">
								</div>
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" name="total_amount_spent" value="{{ $getSingleData->total_amount_spent }}" required>
								</div>
							    </div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/Research/TrainingForm/training-form-update.js')}}"></script>
@endsection