...
@section('page-header')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Stitching registration</h2>
							<ol class="breadcrumb">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('dhaaga-clothings/women-stitching-registration/create') }}"><i class="fe fe-download"></i> Add New Record</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Stitching Registration</h6>
									...
									<div class="table-responsive">
										<table class="table" id="tblStitching">
											<thead>
												<tr>
													...
													<th class="wd-25p">Contact details</th>
													<th class="wd-25p">Speciality</th>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						...
						<form id="deleteData" > 
							@csrf
							 @method('DELETE')
						<input type="hidden" name="stitchId" id="stitchId">
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/womenStitchingRegistrationRecord/stitching-registrations-list.js')}}"></script>
