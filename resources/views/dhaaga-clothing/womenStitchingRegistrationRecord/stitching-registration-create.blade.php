...
<div class="row">
	<div class="col-lg-12">
		<div class="card custom-card">
			<div class="card-body">
				<div>
					<h6 class="card-title mb-1">Add Stitching Registration</h6>

				</div>
				<div class="mt-3 mb-3">
					<form  id="formStitchingRecordCreate">
						@csrf
						<div class="">
							<div class="row">
								...
								<div class="form-group">
									...
									<input type="text" name="cnic" class="form-control" placeholder="Number sold">
                                </div>
                                </div>
							...
							<div class="row">
								...
								<div class="form-group">
									...
									<input class="form-control" name="phoneNo" placeholder="Amount Received" required="" type="text">
                                </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="specility" placeholder="Amount Received" required="" type="text">
                                    </div>
                                    </div>
							</div>
                            <div class="row">
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/womenStitchingRegistrationRecord/stitching-registration-create.js')}}"></script>
