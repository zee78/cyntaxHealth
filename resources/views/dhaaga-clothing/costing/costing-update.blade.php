...
<div class="row">
	<div class="col-lg-12">
		<div class="card custom-card">
			<div class="card-body">
				<div>
					<h6 class="card-title mb-1">Update Costing</h6>
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<select name="type" class="form-control">
											<option value="{{ $getSingleData->type }}" selected=""> {{ $getSingleData->type }}</option>
							...
							<div class="row">
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" name="marketing_cost" id="direct_cost" placeholder="marketing cost" value="{{ $getSingleData->marketing_cost }}" required="" type="text">
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										<label class="form-label">Profit %age: <span class="tx-danger">*</span></label>
										<input class="form-control" name="profit_percentage" value="{{ $getSingleData->profit_percentage }}" placeholder="Profit %age" required="" type="text">
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" name="profit_amount" value="{{ $getSingleData->profit_amount }}" placeholder="Profit amount in rs" required="" type="text">
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
									...
									<div class="form-group">
										...
										<input class="form-control" name="gst" id="gst" value="{{ $getSingleData->gst }}" placeholder="GST" required="" type="text">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" name="total_direct_cost" placeholder="Total direct cost" value="{{ $getSingleData->total_direct_cost }}" required="" type="text">
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										<label class="form-label">Market retail price: <span class="tx-danger">*</span></label>
										<input class="form-control" name="market_retail_price" value="{{ $getSingleData->market_retail_price }}" placeholder="Market retail price" required="" type="text">
									</div>
								</div>
							</div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/costing/costing-update.js')}}"></script>
<script>
