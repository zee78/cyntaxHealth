...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('dhaaga-clothings/costing/create') }}"><i class="fe fe-download"></i> Add New Costing</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
							...
							<div class="card custom-card">
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table" id="tblCosting">
											<thead>
												<tr>
													...
													<th class="wd-25p">Marketing Cost</th>
													<th class="wd-25p">Profit %age</th>
													<th class="wd-25p">Profit Amount in Rs</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/costing/costings-list.js')}}"></script>
