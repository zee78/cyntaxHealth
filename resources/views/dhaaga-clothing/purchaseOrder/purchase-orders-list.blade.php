...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('dhaaga-clothings/purchase-order/create') }}"><i class="fe fe-download"></i> Add New Order</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
										...
										<table class="table" id="tblOrder">
											<thead>
												<tr>
													...
													<th class="wd-25p">Items</th>
													<th class="wd-25p">Order Placed By</th>
													<th class="wd-25p">Date</th>
													<th class="wd-25p">Vendor Name</th>
													<th class="wd-25p">Cost</th>
													<th class="wd-25p">Approved By</th>
													<th class="wd-25p">Order Procurement Person</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/PurchaseOrder/purchase-orders-list.js')}}"></script>
