...
<div class="row">
	<div class="col-lg-12">
		<div class="card custom-card">
			<div class="card-body">
				<div>
					<h6 class="card-title mb-1">Update Purchase Order</h6>
					
				</div>
				<div class="mt-3 mb-3">
					<form  id="formOrderUpdate">
						@csrf
						<div class="">
							<div class="row">
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" name="placed_by" value="{{ $getSingleData->order_placed_by }}" placeholder="Order Placed By" required="" type="text">
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-12 col-lg-12">
									<div class="form-group">
										...
										<input type="text" class="form-control form-control-tags-input" data-role="tagsinput"  name="order_items" value="{{ $getSingleData->order_items }}" id="order_items"placeholder="order items" />
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control fc-datepicker" name="date" placeholder="MM/DD/YYYY" required="" value="{{ $getSingleData->order_date }}" type="text">
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control" name="cost" value="{{ $getSingleData->cost }}" placeholder="Enter Cost" required="" type="text">
									</div>
								</div>
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										<label class="form-label">Order Procurement Person: <span class="tx-danger">*</span></label>
										<input class="form-control" name="procurement_person" value="{{ $getSingleData->order_procurement_by }}" placeholder="Order Procurement Person" required="" type="text">
									</div>
								</div>
							...
							<div class="row">
								<div class="col-md-6 col-lg-6">
									<div class="form-group">
										...
										<input class="form-control fc-datepicker" name="receiving_date" placeholder="MM/DD/YYYY" value="{{ $getSingleData->order_receiving_date }}" required="" type="text">
									</div>
								</div>
							</div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/PurchaseOrder/purchase-order-update.js')}}"></script>
@endsection