...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('dhaaga-clothings/women-product-registration/create') }}"><i class="fe fe-download"></i> Add New Record</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Product Registration</h6>
										...
										<table class="table" id="tblProductData">
											<thead>
												<tr>
													...
													<th class="wd-25p">Contact deatils</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/womenPreparedProductsRegistrationRecord/product-registrations-list.js')}}"></script>
