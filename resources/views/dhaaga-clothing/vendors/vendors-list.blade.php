...
@section('page-header')
					...
					<div class="page-header">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('dhaaga-clothings/vendors/create') }}"><i class="fe fe-download"></i> Add New Vendor</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
										...
										<table class="table" id="tblVendors">
											<thead>
												<tr>
													...
													<th class="wd-25p">Products purchased</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/vendors/vendors-list.js')}}"></script>
