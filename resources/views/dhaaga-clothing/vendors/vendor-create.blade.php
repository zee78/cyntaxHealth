							...
							<div class="row">
                                <div class="col-lg-6 col-md-6">
                                    ...
                                    <div class="form-group">
										...
										<input type="text" class="form-control form-control-tags-input" data-role="tagsinput"  name="product_purchased" id="team_members"placeholder="purchased products" />
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/vendors/vendor-create.js')}}"></script>
