						...
						<div class="">
							<div class="row">
								...
								<div class="form-group">
									...
									<input type="text" name="number_sold" class="form-control" placeholder="Number sold">
                                </div>
                                </div>
								<!-- ****************** employee last name *************** -->
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/DhaagaClothings/TrendAnalysis/trend-analysis-create.js')}}"></script>
