...
<div class="row">
	<div class="col-lg-12">
		<div class="card custom-card">
			<div class="card-body">
				<div>
					<h6 class="card-title mb-1">Add 1.	Poultry Registration Record</h6>

				</div>
				<div class="mt-3 mb-3">
					<form  id="formPoultryRecordCreate">
						@csrf
						<div class="">
                            <div class="row">
                            ...
                            <div class="row">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control" name="phoneNo" placeholder="phone number" required="" type="text">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control fc-datepicker" name="enrolment_date" placeholder="MM/DD/YYYY" required="" type="text">
                                </div>
                                </div>
							...
							<div class="row">
								...
								<div class="form-group">
                                    ...
                                    <input class="form-control" name="number_of_poultry_given" placeholder="phone number" required="" type="text">
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/communityEmpowerment/poultryRegistrationRecord/poultry-registration-record-create.js')}}"></script>
