	...
	<div class="col-lg-12">
		<div class="card custom-card">
			<div class="card-body">
				...
				<div class="mt-3 mb-3">
					<form  id="formDailyExpenseCreate">
						@csrf
						<div class="">
							<div class="row">
							...
							<div class="row">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-tags-input" data-role="tagsinput"  name="name_of_items_purchased" id="name_of_items_purchased" placeholder="name of items purchased" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="purchased_by" placeholder="Purchased by" required="" type="text">
                                    </div>
                                </div>
                            </div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/dastarkhwan/daily-expense-sheet/daily-expense-sheet-create.js')}}"></script>
