...
@section('page-header')
					...
					<div class="page-header">
						<div>
							<h2 class="main-content-title tx-24 mg-b-5">Dastarkhwan Daily Record</h2>
							<ol class="breadcrumb">
						...
						<div class="btn btn-list">
							...
							<a class="btn ripple btn-secondary" href="{{ url('/dastarkhwan/daily-dastarkhwan-record/create') }}"><i class="fe fe-download"></i> Add New Record</a>
						</div>
					</div>
					<!-- End Page Header -->
@endsection
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card custom-card">
								<div class="card-body">
									<div>
										<h6 class="card-title mb-1">Daily Dastarkhwan Record</h6>
									...
									<div class="table-responsive">
										<table class="table" id="tblDailyRecord">
											<thead>
												<tr>
													<th class="wd-20p">Sr#</th>
													<th class="wd-25p">Date</th>
													<th class="wd-25p">Location</th>
													<th class="wd-25p">Timing</th>
													<th class="wd-25p">Names of items distributed</th>
													<th class="wd-25p">Number of people</th>
													<th class="wd-25p">Amount collected</th>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/dastarkhwan/daily-dastarkhwan-record/daily-dastarkhwan-records-list.js')}}"></script>
