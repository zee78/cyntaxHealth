  ...
  <div class="col-lg-12">
    <div class="card custom-card">
      <div class="card-body">
        ...
        <div class="mt-3 mb-3">
          <form  id="formDailyRecordUpdate">
            @csrf
            <div class="">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <input type="hidden" name="recordId" id="recordId" value="{{$getSingleData->id}}">
                  <div class="form-group">
                    <label class="form-label">Date: <span class="tx-danger">*</span></label>
                    <input class="form-control fc-datepicker" name="date" value="{{$getSingleData->date}}" placeholder="MM/DD/YYYY" required="" type="text">
                  </div>
                </div>
                <!-- ***************** eployee first name  -->
                <div class="col-lg-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="location" value="{{$getSingleData->location}}" class="form-control" placeholder="Location">
                  </div>
                </div>
                <!-- ****************** employee last name *************** -->
              </div>
              <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-tags-input" data-role="tagsinput"  name="name_of_items_distributed" value="{{$getSingleData->name_of_item_distributed}}" id="name_of_items_distributed" placeholder="name of items distributed" />
                  </div>
                </div>
              </div>
              <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="form-group">
                    ...
                    <select name="timing" class="form-control">
                      <option value="{{$getSingleData->timing}}" selected="">{{$getSingleData->timing}}</option>
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="number_of_people" value="{{$getSingleData->number_of_people}}" class="form-control" placeholder="Total cost">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="amount_collected" value="{{$getSingleData->amount_collected}}" class="form-control" placeholder="Amount collected">
                  </div>
                </div>
              </div>
...
<!-- ********************** custom js file here *********************** -->
<script src="{{ URL::asset('assets/CustomJs/dastarkhwan/daily-dastarkhwan-record/daily-dastarkhwan-record-update.js')}}"></script>
@endsection